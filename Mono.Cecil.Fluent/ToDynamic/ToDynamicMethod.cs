...
namespace Mono.Cecil.Fluent
{
	public static partial class MethodDefinitionExtensions
	{
	    ...
	    public static MethodInfo ToDynamicMethod(this MethodDefinition method, TypeBuilder declaringtype, MethodInfo target = null)
		{
			...
			if(returntype == null)
				throw new InvalidOperationException($"can not find return type {method.ReturnType.FullName} in current appdomain");
			...
			foreach (var p in method.Parameters)
			{
				...
				if(paramtype == null)
					throw new InvalidOperationException($"can not find parameter type {p.ParameterType.FullName} in current appdomain");
