...
namespace Mono.Cecil.Fluent
{
	...
	{
		public static FluentMethodBody NewMethod(this TypeDefinition type, string name = null, 
		...
		public static FluentMethodBody NewMethod<T>(this TypeDefinition type, string name = null,
			MethodAttributes? attributes = null)
		{
			return NewMethod(type, name, typeof(T), attributes);
		}

		public static FluentMethodBody NewMethod(this TypeDefinition type, string name, Type returnType,
			MethodAttributes? attributes = null)
		{
			return NewMethod(type, name, type.Module.SafeImport(returnType), attributes);
		}

		public static FluentMethodBody NewMethod(this TypeDefinition type, Type returnType, MethodAttributes? attributes = null)
		{
